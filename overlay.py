...
class AmadeusVN:
    ...
    def bangun_ui_utama(self):
        ...
        self.label_saldo.bind("<Button-1>", lambda e: self.tampilkan_menu_overlay("visualisasi"))
    ...
    def tampilkan_menu_overlay(self, tab_name):
        if tab_name == "transaksi":
            tab_name = "visualisasi"
            
        self.title_titles = {
            "transaksi": "📊 Analisis & Riwayat Keuangan",
            "visualisasi": "📊 Analisis & Riwayat Keuangan",
    ...
    def render_tab_visualisasi(self):
        ...
        self.tree.heading("Kategori", text="Kat")
        self.tree.heading("Deskripsi", text="Deskripsi")

        self.tree.column("ID", width=30, minwidth=20, anchor=tk.CENTER)
        self.tree.column("Waktu", width=90, minwidth=80, anchor=tk.CENTER)
        self.tree.column("Jenis", width=60, minwidth=50, anchor=tk.CENTER)
        self.tree.column("Nominal", width=80, minwidth=70, anchor=tk.E)
        self.tree.column("Kategori", width=65, minwidth=50, anchor=tk.W)
        self.tree.column("Deskripsi", width=120, minwidth=80, anchor=tk.W)
        ...
        def isi_tabel():
            ...
            for r_id, tgl, jns, nom, kat, dsk in records_data:
                ...
                self.tree.insert("", tk.END, values=(r_id, tgl[5:16], jns.upper(), nominal_fmt, kat, dsk), tags=(tag,))
        ...
        btn_analisis = tk.Button(control_frame, text="📊 Analisis AI", font=("Consolas", 8, "bold"),
                                 ...
                                 relief=tk.FLAT, command=self.minta_analisis_pengeluaran, padx=5, pady=3)
        ...
        btn_export = tk.Button(control_frame, text="Export CSV", font=("Consolas", 8, "bold"),
                               ...
                               relief=tk.FLAT, command=self.ekspor_riwayat_csv, padx=5, pady=3)
        ...
        btn_hapus_semua = tk.Button(control_frame, text="Hapus Semua", font=("Consolas", 8, "bold"),
                                    ...
                                    relief=tk.FLAT, command=self.hapus_seluruh_riwayat, padx=5, pady=3)
...
# --- LOGIKA KOMUNIKASI & EKSPRESI ---
    ...
    def hapus_seluruh_riwayat(self):
        ...
        if hapus_semua_transaksi():
            ...
            # Jika overlay panel sedang terbuka di tab visualisasi, refresh
            if self.active_tab == "visualisasi":
                self.render_tab_visualisasi()
        else:
