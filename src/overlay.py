import os
# Ubah direktori kerja ke folder root project agar aset selalu termuat dengan benar
...
from ui.tabs import render_tab_visualisasi, render_tab_tugas, render_tab_catatan, render_tab_log, render_tab_settings
...
class AmadeusVN:
    ...
    def render_tab_visualisasi(self):
        render_tab_visualisasi(self)

    def render_tab_log(self):
        render_tab_log(self)

    def render_tab_settings(self):
        render_tab_settings(self)
